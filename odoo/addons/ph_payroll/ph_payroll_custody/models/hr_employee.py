# -*- coding: utf-8 -*-
###################################################################################
#    A part of PH Payroll Project <https://www.openhrms.com>
#
...
class HrCustody(models.Model):
    ...
    def custody_view(self):
        for each1 in self:
            ...
            view_id = self.env.ref('ph_payroll_custody.hr_custody_form_view').id
            if custody_ids:
    ...
    def equipment_view(self):
        for each1 in self:
            ...
            view_id = self.env.ref('ph_payroll_custody.custody_custody_form_view').id
            if equipment_ids:
