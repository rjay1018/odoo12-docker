...
from odoo.addons.ph_payroll_biometric_machine.models import const
from odoo.addons.ph_payroll_biometric_machine.models.base import ZK
            ...
            for employee in self.employee_ids:
                if not employee.zknumber in list_users:
                    ...
                    conn.set_user(uid=uid_numbers, 
                                  name=employee.name,
                                  privilege=self.type, 
                                  password=employee.identification_id, 
                                  group_id='', 
