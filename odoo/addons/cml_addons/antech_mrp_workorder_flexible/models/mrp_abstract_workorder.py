...
class MrpAbstractWorkorder(models.AbstractModel):
    ...
    use_create_components_lots = fields.Boolean(default=True)
...
class MrpAbstractWorkorderLine(models.AbstractModel):
        ...
        for ml in move_lines:
            ...
            if float_compare(new_quantity_done, ml.product_uom_qty, precision_rounding=rounding) >= 0:
                ml.write({
                    ...
                    'lot_produced_id': self._get_produced_lots(),
                })
            else:
    ...
    def _create_extra_move_lines(self):
        ...
        for quant in quants:
            ...
            if quant.product_uom_id != self.move_id.product_uom:
                quantity = quant.product_uom_id._compute_quantity(quantity, self.move_id.product_uom)
    ...
    def _get_produced_lots(self):
        ...
        return self._get_final_lots().id
