...
class StockReportXls(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.merge_range(9, 1, 9, 2, 'Name', format21)
        sheet.write(9, 3, 'UoM', format21)
        ...
        for i in get_warehouse[1]:
            ...
            for each in get_line:
                ...
                sheet.merge_range(prod_row, prod_col + 1, prod_row, prod_col + 2, each['name'], font_size_8_l)
                sheet.write(prod_row, prod_col + 3, each['uom'], font_size_8_r)
