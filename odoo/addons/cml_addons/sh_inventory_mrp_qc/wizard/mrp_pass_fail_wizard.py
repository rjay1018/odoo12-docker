...
class MrpPassFailWizard(models.TransientModel):
    _name = 'sh.mrp.pass.fail'
    _description = 'MEP Quality Measurement Pass Fail'
    ...
    def default_get(self, fields):
        res = super(MrpPassFailWizard, self).default_get(fields)
