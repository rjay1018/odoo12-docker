    ...
    var IZIViewVisual = Widget.extend({
        ...
        _makeChart: function (result) {
            ...
            var visual = new amChartsComponent({
                ...
                // Scorecard Basic customizations
                scorecardBgColor: result.visual_config_values.scorecardBgColor,
                scorecardIconType: result.visual_config_values.scorecardIconType,
